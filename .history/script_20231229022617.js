...
const humanTurn = () => {
  ...
  const aiTurn = () => {
    ...
    // Check if exactly two common elements exist for each subarray
    const matchingPatterns1 = winningPatterns.filter((pattern) => {
    ...
    if (matchingPatterns1.length > 0) {
      console.log("MATCH");
      console.log("Matching Patterns:", matchingPatterns1);
    } else {
